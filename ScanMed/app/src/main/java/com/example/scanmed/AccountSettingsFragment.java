...
public class AccountSettingsFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding.backButton1.setOnClickListener(new View.OnClickListener(){
            public void onClick(View v){
                ...
                AccountSettingsFragment accountFragment = AccountSettingsFragment.newInstance("account-seetingd", "account-settings");
                fragmentTransaction.add(R.id.main, accountFragment);
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        binding.backButton1.setEnabled(false);
    }
